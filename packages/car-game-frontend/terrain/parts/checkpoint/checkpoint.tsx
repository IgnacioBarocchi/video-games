...
Command: npx gltfjsx@6.1.11 assets/models/Checkpoint/Checkpoint.glb -t -r public
*/
...
function createOnceFunction(callback: (payload: CollisionPayload) => void) {
  let hasBeenCalled = false;

  return function (payload: CollisionPayload) {
    if (!hasBeenCalled) {
      callback(payload);
      hasBeenCalled = true;
    }
