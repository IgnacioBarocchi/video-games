...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/../src/assets/models/mac/MacOS.glb') as GLTFResult
  return (
    <group {...props} dispose={null}>
      <group rotation={[Math.PI / 2, 0, 0]} scale={0.07}>
        <mesh geometry={nodes.Plane.geometry} material={materials.Zombie_base} />
        ...
        <mesh geometry={nodes.Plane_4.geometry} material={materials.Blood_shade} />
...
useGLTF.preload('/../src/assets/models/mac/MacOS.glb')
